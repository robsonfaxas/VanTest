...
{
    public abstract class VanhackTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VanhackTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VanhackTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VanhackTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VanhackTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VanhackTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VanhackTestDbContext, Task<T>> func)
        {
            T result;
